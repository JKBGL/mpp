...
CURRENT STATUS: BROKEN, DO NOT USE IN PRODUCTION
...
public:
    static double calculatePP(double difficulty, int score, double od, int note_count, int mods = 0, bool debug = false) {
        ...
        int real_score = score / score_rate;
